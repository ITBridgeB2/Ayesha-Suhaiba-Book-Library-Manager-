...
function AddBook() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      // Call the addBook method from bookService to add the new book
      await bookService.addBook(book.title, book.author, book.genre, book.publishedYear, 'General');
